...
public class Emotion3Fragment extends Fragment {
...
//    private TextView textView6;
    ...
    public static Emotion3Fragment newInstance(){
        return new Emotion3Fragment();
    }

    private android.content.res.Resources resources; // 색, 카트리지 정보 배열 얻기 위해
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button1 = (Button) viewGroup.findViewById(R.id.emotion3_fragment_button1);
        button2 = (Button) viewGroup.findViewById(R.id.emotion3_fragment_button2);
        button3 = (Button) viewGroup.findViewById(R.id.emotion3_fragment_button3);
        button4 = (Button) viewGroup.findViewById(R.id.emotion3_fragment_button4);
        button5 = (Button) viewGroup.findViewById(R.id.emotion3_fragment_button5);
...
//        textViews = new TextView[]{textView1, textView2, textView3, textView4, textView5, textView6};
        ...
        timeSeekBar = (SeekBar) viewGroup.findViewById(R.id.emotion3_fragment_seekbar_time);
        timeView = (TextView) viewGroup.findViewById(R.id.emotion3_fragment_textview_time);

        turnon = (Button) viewGroup.findViewById(R.id.emotion3_fragment_turnon_button);
